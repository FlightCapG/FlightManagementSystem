...
public class FlightDTOConvertor {
	...
	public FlightDTO getFlightDTO(Flight flight) {
		return new FlightDTO(flight.getFlightId(), flight.getCarrierName(), flight.getSeatCapacity(),
				flight.getSourceAirport(), flight.getDestinationAirport(), flight.getDuration());
	}
}